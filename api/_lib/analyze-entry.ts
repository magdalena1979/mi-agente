...
function buildPrompt(payload: AnalyzeEntryRequest) {
  ...
  return [
    ...
    'Expected JSON shape:',
    '{"detectedType":"movie","title":"string","summary":"string","tags":["string"],"fields":{"author":"","date":"","time":"","location":"","director":"","cast":"","genre":"","year":"","duration":"","platform":"","ingredientsText":"","topic":"","note":""},"confidence":0.0}',
    '',
    'Combined OCR text:',
